...
<div class="D-big">
    ...
    <div class="article-box">
        <div class="tag-list">
            ...
            <Select v-if="author&&typeList.length>0" v-model="articleType" style="width:200px" placeholder="请选择文章类型">
...
export default {
    ...
    computed: {
        ...
        selectType: function () {
            var typeList = this.author == 'tinger' ? this.tingerType : this.whereType;
            return typeList;
        }
    },
    methods: {
    ...
    mounted() {
        ...
        //获得类型和列表
        this.getListType('tinger').then(data => this.tingerType = data);
        this.getListType('where').then(data => this.whereType = data);
    },
}
</script>
